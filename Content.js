...
console.log("content.js of YouTube Playlist Duration Extension :)");

let myAPIKey = `AIzaSyDETRmlcV240mdwM_SEZsbS0vfag3Mzmm8`;
let currURL;
...
async function getPlaylistDurationFromURL(URL) {
    ...
    try {
        ...
        // console.log("Total Duration Object: ");
...
//     //         : "from the extension"
//     // );
//     if (request === "sendPlaylistDurationPlease:)") {
//         let currTabURL;
//         currTabURL = location.href;
//         console.log("currTabURL : " + currTabURL);
//         if (!currTabURL) {
//             console.log("NO URL");
//             return null;
//         }
//         if (currTabURL && currTabURL === currURL) {
//             console.log("Already computed duration for this URL   :)");
//             return currDurationObject;
//         }
//         //* else : Display playlist Duration
//         displayFetchingDetails();
//         currURL = currTabURL;
//         try {
//             // const { playlistID, totalDuration, countTotalVid, countPublicVid } = await getPlaylistDurationFromURL(currURL);
//             const data = await getPlaylistDurationFromURL(currURL);
//             sendResponse(data);
//         } catch (error) {
